...
import photo1 from "../../assets/images/pension.jpg";
...
const MicroPension = () => {
	...
	return (
		<div>
			<Container>
				<Typography>Micro Pension Scheme for Farmer</Typography>
					...
					<Grid item md={8}>
						<Card className={classes.card}>
							...
							<Box className={classes.newBody}>
								<h6>
									Please enter your details below to apply for the Micro Pension scheme
								</h6>
								<hr />
								<Row>
									<Col md={6}>
									...
									<Col md={6}>
										<Form.Group controlId="returnDate">
											<label for="birthday">Commencement Date</label>
											<br />
